...
<html lang="en">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="" href="pages/icons/simple-line-icons.html" >
            ...
            <li class="nav-item">
              <a class="nav-link" href="" href="pages/forms/basic_elements.html">
                <span class="menu-title">Delete Medicines</span>
 ...
 <% 
    	...
    	{   
    		...
    		PreparedStatement p1 = con.prepareStatement("select * from medicine_tbl where memail=?");
            ...
            <tbody>
		      ...
		      <td><%=r1.getString("mdbrand") %></td>
		       ...
		       <td><%=r1.getString("mdprice") %></td>  
		        <td><a href="deletemedicine.jsp?mid=<%= r1.getString("mdid") %>">Delete</a></td>
              </tr>
                      </tbody>
 <%
    		}
