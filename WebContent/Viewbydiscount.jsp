...
<html lang="en">
 ...
 <%        
    	...
    	{   
    		...
    		int originalPrice = Ulatlng.getMdprice();
            int discountPercentage =Ulatlng.getMddiscount();
      		int discountedPrice = discount.calculateDiscountedPrice(originalPrice, discountPercentage);
    		String mddiscount = request.getParameter("mddiscount");
    		Connection con = ConnectDB.connect();
    		PreparedStatement p1 = con.prepareStatement("select * from medicine_tbl where mdname=?");
    		p1.setString(1, mddiscount);
